...
/**
 * Sidebar berlabel adalah default — ERP ini punya sembilan menu dan ikon saja
 * memaksa user menghafal. Rail ikon tersedia lewat tombol ciutkan, dan
 * pilihannya diingat antar sesi.
 */
const SIDEBAR_KEY = 'ginkgo-living.sidebar-collapsed.v1'
...
const pageTitle = computed(() => route.meta.title ?? 'Ginkgo Living ERP')
